...
- в полноэкранном просмотре первый тап по метке активирует её на 3 секунды —
  за это время нужно нажать и перетащить метку; отпускание пальца фиксирует позицию;
